...
int main_M_S_R_D()
{
	...
	error = M_S_R_D_Initialization("02062435", 2, 0, 0, 0, 0, 0, &MyM_S_R_D_ID);//remember that sensors 1-2 and 3-4 should be the same kind //the sensors types have to be the same as in the next function "Add_Sens" (CustomSens_Voltage_Ch12 and Ch34 is used for CustomSensors only, voltage is between 5 and 25V)
